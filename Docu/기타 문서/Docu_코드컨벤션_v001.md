...
## 개요
- 본 프로젝트 진행 간 코드 작성 및 유지보수에 있어 통일성 유지로 가독성 향상, 작업환경 및 소요시간의 효율성을 높이기 위함
...
#### 클래스 및 파일 명
- 파스칼 케이스 적용
- 프리팹, 스크립트 외 같은 포맷의 파일이 여러개일 경우 용도별로 정렬하기 위해 `파일타입_용도_파일명(파스칼케이스)_번호` 적용
...
Audio_BGM_Normal_01.mp3
Audio_BGM_EventGagueMax_01.mp3

Audio_SE_NormalClick_01.mp3
Audio_SE_ButtonClick_01.mp3
